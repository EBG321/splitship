...
import '../auth_screen/auth_controller.dart';
...
class SplitShipPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Fetch all containers initially
    locationController.fetchAndSetContainers();

    return Scaffold(
      backgroundColor: Color.fromARGB(100, 0, 128, 0), // Semi-transparent green
      appBar: AppBar(
        toolbarHeight: 80,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            // Dropdown for "From" and "To" locations
            Row(
            ...
            // Container List
            Obx(() {
              if (locationController.containers.isEmpty) {
                return Text(
              ...
              return Wrap(
                spacing: 16,
                runSpacing: 16,
                children: locationController.containers.map((container) {
                  return GestureDetector(
                    onTap: () {
                      ...
                      // Navigate to a container details page if needed
                    },
        ...
        content: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: 16),
              // Max Price Filter
              Text('Max Price: \$${locationController.maxPrice.value.toStringAsFixed(2)}'),
              Obx(() => Slider(
                value: locationController.maxPrice.value,
                min: 0.0,
                max: 2000.0,
                divisions: 100,
                label: '\$${locationController.maxPrice.value.round()}',
                onChanged: (value) {
                  locationController.updatePriceRange(
                      locationController.minPrice.value, value);
                },
              )),
              SizedBox(height: 16),
              // Sorting Filter
              Obx(() {
                return DropdownButtonFormField<String>(
                  ...
                  onChanged: (value) {
                    if (value != null) locationController.sortBy.value = value;
                  },
                );
              }),
              SizedBox(height: 24),
